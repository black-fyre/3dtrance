...
CKEDITOR.lang['fr'] = {
    ...
    "elementspath": {"eleLabel": "Elements path", "eleTitle": "%1 éléments"},
    "find": {
        "find": "Trouver",
    ...
    "font": {
        "fontSize": {"label": "Taille", "voiceLabel": "Taille de police", "panelTitle": "Taille de police"},
        "label": "Police",
    ...
    "smiley": {"options": "Options des émoticones", "title": "Insérer un émoticone", "toolbar": "Émoticone"},
    ...
    "magicline": {"title": "Insérez un paragraphe ici"},
    "maximize": {"maximize": "Agrandir", "minimize": "Minimiser"},
    "newpage": {"toolbar": "Nouvelle page"},
    "pagebreak": {"alt": "Saut de page", "toolbar": "Saut de page"},
    "pastetext": {"button": "Coller comme texte sans mise en forme", "title": "Coller comme texte sans mise en forme"},
    "pastefromword": {
