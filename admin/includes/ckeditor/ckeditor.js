...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > f.getListenerIndex(d)) {
                    ...
                    q.fn = d;
                    q.priority = k;
                    for (var A = f.length - 1; 0 <= A; A--) if (f[A].priority <= k) return f.splice(A + 1, 0, q), {removeListener: w};
                    f.unshift(q)
                }
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, e = /</g, g = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            k = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, q = function (a, f) {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c)) var p = "\x3c" + k + "\x3e", q = "\x3c/" + k + "\x3e",
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, l = {}, k = {"#": 1},
            q = {center: 1, dir: 1, noframes: 1};
        a(b, {
            a: 1,
            abbr: 1,
            area: 1,
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var t =
                            this.$.getBoundingClientRect(), g = f.$.documentElement, p = g.clientTop || d.$.clientTop || 0,
                        x = g.clientLeft || d.$.clientLeft || 0, l = !0;
                ...
                d = p(this, e);
                var u =
                    p(a, e), r = this.$.offsetHeight;
                f = this.$.offsetWidth;
                var h = a.$.clientHeight, n = a.$.clientWidth;
            ...
            copyAttributes: function (a, b) {
                ...
                for (var f = 0; f < c.length; f++) {
                    var d = c[f], e = d.nodeName.toLowerCase(), t;
                    if (!(e in b)) if ("checked" == e && (t = this.getAttribute(e))) a.setAttribute(e, t); else if (!CKEDITOR.env.ie || this.hasAttribute(e)) t = this.getAttribute(e), null === t && (t = d.nodeValue), a.setAttribute(e, t)
                }
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, y = c.endOffset, r, h = this.guard, n = this.type,
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(),
            l = CKEDITOR.dom.walker.bookmark(), k = CKEDITOR.dom.walker.temp(), q = function (a) {
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            ...
            a.optimizeBookmark();
            var k = 0 === b, r = 1 == b, h = 2 == b;
            b = h || r;
            var n = a.startContainer, m = a.endContainer,
                z = a.startOffset, B = a.endOffset, E, C, H, w, q, Q;
            if (h && m.type == CKEDITOR.NODE_TEXT && n.equals(m)) n = a.document.createText(n.substring(z, B)), c.append(n); else {
                ...
                K = c;
                for (N = J; N <= L; N++) if (c = I[N], V = c.getPrevious(), c.equals(v[N])) b && (K = K.getChild(0)); else {
        ...
        var g = {
                ...
                u: 1,
                "var": 1
            }, l = CKEDITOR.dom.walker.bogus(), k = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, q = CKEDITOR.dom.walker.editable(),
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var g = this.getCommonAncestor(), l = this.root, k, r, h, n, m, z = !1, B, E;
                        ...
                        for (h = c(h); h || n;) {
                            ...
                            for (; n;) if (B = !1, n.type == CKEDITOR.NODE_COMMENT) n = n.getPrevious(); else {
                                if (n.type == CKEDITOR.NODE_TEXT) E = n.getText(), d.test(E) && (n = null), B = /[\s\ufeff]$/.test(E); else if ((n.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && n.is("br")) && !n.data("cke-bookmark")) if (z && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                    E = n.getText();
                                    if (d.test(E)) n = null; else for (var C = n.$.getElementsByTagName("*"), H = 0, w; w =
                                        C[H++];) if (!CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]) {
                                        n = null;
                                        break
                                    }
                                    n && (B = !!E.length)
                        ...
                        for (; h ||
                            ...
                            for (; n;) {
                                B = !1;
                                if (n.type == CKEDITOR.NODE_TEXT) E = n.getText(), p(n, 0) || (n = null), B = /^[\s\ufeff]/.test(E); else if (n.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < n.$.offsetWidth || b && n.is("br")) && !n.data("cke-bookmark")) if (z && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                        E = n.getText();
                                        if (d.test(E)) n = null; else for (C = n.$.getElementsByTagName("*"), H =
                                            0; w = C[H++];) if (!CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]) {
                                            n = null;
                                            break
                                        }
                                        n && (B = !!E.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var q, Q,
                            v = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                            I = null, J = function (a) {
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            h = this.clone();
                            h = new CKEDITOR.dom.walker(h);
                            var F = CKEDITOR.dom.walker.whitespaces(), L = CKEDITOR.dom.walker.bookmark();
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    l = p.startPath();
                    var x = p.endPath(), G = !p.collapsed && c(p, l.block), u = !p.collapsed && c(p, x.block, 1);
                ...
                for (this._.nextNode = null; x;) {
                    var G = 0, u = x.hasAscendant("pre"), r = x.type != CKEDITOR.NODE_ELEMENT, h = 0;
                    if (r) x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (r = 0); else {
                        var n = x.getName();
                        if (CKEDITOR.dtd.$block[n] && "false" == x.getAttribute("contenteditable")) {
                            d = x;
                            b(this, a, d);
                            break
                        } else if (x.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                            if ("br" == n) r = 1; else if (!l && !x.getChildCount() && "hr" != n) {
                                d = x;
                                A = x.equals(p);
                                break
                            }
                    ...
                    if (l && !G) for (; !x.getNext(k) && !A;) {
                        n = x.getParent();
                        if (n.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                            G = 1;
                            r = 0;
                            A || n.equals(p);
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (h in b) {
                n = b[h];
                n = "boolean" == typeof n ? {} : "function" == typeof n ? {match: n} : H(n);
                ...
                for (p in Q) {
                    m[p] = l(m[p], f) || null;
                    var F = m, r = v[p], g = l(m[v[p]], f), z = m[p], E = [], B = !0, L = void 0;
                    g ? B = !1 : g = {};
        ...
        function t(a, b, h, e) {
            ...
            if (e.doFilter) {
                ...
                var B = a.validStyles;
                f = a.validClasses;
                var g = b.attributes, k = b.styles, r = b.classes;
                z = b.classBackup;
                var J = b.styleBackup, C, I, K = [], E = [], H = /^data-cke-/;
                v = !1;
                delete g.style;
                delete g["class"];
        ...
        function h(a, b, c) {
            ...
            if (C.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (C.$block[d] || "tr" == d) if ("br" == b) a.previous && !r(a.previous) && (b = u(), b.insertBefore(a)), a.next && !r(a.next) && (b = u(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, h;
                b:{
                    h = C[b];
        ...
        function m(a, b) {
            var c = b.getDefinition(), d = c.attributes, h = c.styles, n, e, m, f;
        ...
        var C = CKEDITOR.dtd, H = CKEDITOR.tools.copy, R = CKEDITOR.tools.trim, T = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var n = this, e = [], m = this.editor && this.editor.config.protectedSource, f, g = !1,
                    p = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (f = t(n, a, e, p), f & 1) g = !0; else if (f & 2) return !1
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        b = a[h];
                        var n = void 0, e = void 0, m = void 0, f = void 0, g = void 0, r = void 0;
                        c = [];
                ...
                var m = CKEDITOR.tools.clone(h), g = [], r;
                if (!1 !== b && (r = this._.transformations[h.name])) {
                    for (d =
                             0; d < r.length; ++d) n(this, h, r[d]);
                    p(h)
                }
                t(this, m, g, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        var Q = {styles: 1, attributes: 1, classes: 1},
            v = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"},
            I = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
            J = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, F = /^cke:(object|embed|param)$/,
            L = /^(object|embed|param)$/, K;
            ...
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles,
                        h = c.attributes, n, m, e, f;
                    a.name = c.element;
                    for (n in h) if ("class" == n) for (c = a.classes.join("|"), e = h[n].split(/\s+/); f = e.pop();) -1 == c.indexOf(f) && a.classes.push(f); else a.attributes[n] = h[n];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, e, g) {
                ...
                l && (b = [b]);
                e || (e = CKEDITOR);
                var k = b.length, q = [], w = [], f = function (a) {
        ...
        function y(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                CKEDITOR.scriptLoader.load(e, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], e = 0; e < c.length; e++) for (var n =
                        0; n < d.length; n++) {
                        var m = d[n];
            ...
            function (g, l, k) {
                function q(a) {
                    ...
                    if (0 < x.length) for (var c = 0; c < x.length; c++) {
                        var d = x[c], h = d.name, e = CKEDITOR.dtd[h], f = u.name && CKEDITOR.dtd[u.name];
                    ...
                    if (a(m)) x.push(m); else {
                        ...
                        if ("br" == e) G.push(m); else {
                            for (; !(g = (f = u.name) ? CKEDITOR.dtd[f] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, m.isUnknown || u.isUnknown || g[e]);) if (u.isOptionalClose) D.onTagClose(f); else if (e in b && f in b) f = u.children, (f = f[f.length - 1]) && "li" == f.name || y(f = new CKEDITOR.htmlParser.element("li"), u), !m.returnPoint && (m.returnPoint = u), u = f; else if (e in CKEDITOR.dtd.$listItem &&
                                !t(e, f)) D.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !t(e, f)) !m.returnPoint && (m.returnPoint = u), u = u.parent; else if (f in CKEDITOR.dtd.$inline && x.unshift(u), u.parent) y(u, u.parent, 1); else {
                                m.isOrphan = 1;
                                break
                            }
                            q(e);
                ...
                D.onText = function (a) {
                    ...
                    if (!r && !f["#"] && b in d) D.onTagOpen(e[b] || ""), D.onText(a); else {
                        w();
                        q();
                        h || r || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    g = Array.prototype.slice.call(arguments, 1), l = this.rules, k = l.length, q, w, f, y;
                for (y = 0; y < k; y++) if (d && (q = c.type, w = c.name), f = l[y], !(a.nonEditable && !f.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            ...
            var r = {elements: {}}, v = "html" == d, z = CKEDITOR.tools.extend({}, h), E;
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            h.addRules(z);
            h.addRules(B, {applyToAll: !0});
            h.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, h, c = p(c, b), c = f(c, T), c = w(c), c = f(c, R), c = c.replace(v, "$1cke:$2"),
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                ...
                return h.fire("toHtml", {
                    ...
                    filter: m || h.filter, enterMode: n || h.enterMode, protectedWhitespaces: f
                }).dataValue
        ...
        var x = /(?:&nbsp;|\xa0)$/, G = "{cke_protected}", u = CKEDITOR.dtd,
            r = "caption colgroup col thead tfoot tbody".split(" "), h = CKEDITOR.tools.extend({}, u.$blockLimit,
            u.$block), n = {elements: {input: k, textarea: k}},
            m = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, z = {
                elements: {
                    embed: function (a) {
                        var b = a.parent;
                        if (b && "object" == b.name) {
                ...
                elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/,
                    ...
                    $: function (a) {
                        ...
                        a.children.slice(0).sort(function (a, b) {
                            var c, d;
                            a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(r, a.name), d = CKEDITOR.tools.indexOf(r, b.name));
        ...
        var E = /<(a|area|img|input|source)\b([^>]*)>/gi,
            C = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, H = /^(href|src|name)$/i,
            R = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            T = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, Q = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            v = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            I = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, J = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var q, w;
                for (q in l) {
                    for (k = l[q]; ;) if (w = a.onAttributeName(b, q)) if (w != q) delete l[q], q = w; else break; else {
                        delete l[q];
                        break
                    }
                ...
                b && this.filter(b);
                var g = this.name, l = [], k = this.attributes, q, w;
                a.openTag(g, k);
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, d = a.element, l = a.elementMode, k =
                ...
                q = a.fire("uiSpace", {space: "bottom", html: ""}).html,
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && l && l[a]) {
                ...
                if (d.mode) {
                    var k = d.checkDirty(), l = d._.previousModeData, q, w = 0;
                    d.fire("beforeModeUnload");
                    d.editable(0);
                    d._.previousMode = d.mode;
                    d._.previousModeData = q = d.getData(1);
                    "source" == d.mode && l == q && (d.fire("lockSnapshot", {forceUpdate: !0}), w = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, l) {
            var k = this.container, q = this.ui.space("contents"),
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, m = e.blockLimit, f = a.data.selection, g = f.getRanges()[0], E;
            ...
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                extractHtmlFromRange: function (a, b) {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (m) {
                            var e = d.getHead(), l = e.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in k) {
                                b = a.getSelection();
                                var h, e = b.getRanges()[0], m = e.startPath(), n, l, z, c = 8 == c;
        ...
        p = function () {
            ...
            function b(c, d) {
                var e, f, m, n, g = [], l = d.range.startContainer;
                e = d.range.startPath();
                for (var l = C[l.getName()], z = 0, k = c.getChildren(), E = k.count(), B = -1, p = -1, q = 0, w = e.contains(C.$list); z < E; ++z) e = k.getItem(z), a(e) ? (m = e.getName(), w && m in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (n = !!l[m], "br" != m || !e.data("cke-eol") || z && z != E - 1 || (q = (f = z ? g[z - 1].node : k.getItem(z + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && C.$block[f.getName()]), -1 != B || n || (B = z), n || (p = z), g.push({
                    ...
                    hasBlockSibling: f, node: e, name: m, allowed: n
                }), f = q = 0)) : g.push({isElement: 0, node: e, allowed: 1});
                -1 < B && (g[B].firstNotAllowed = 1);
                -1 < p && (g[p].lastNotAllowed = 1);
                return g
            }

            function d(b, c) {
                var e = [], h = b.getChildren(), f = h.count(), m, g = 0, l = C[c], z = !b.is(C.$inline) || b.is("br");
            ...
            var C = CKEDITOR.dtd, p = {
                ...
                dl: 1,
                blockquote: 1
            }, q = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, w = CKEDITOR.tools.extend({}, C.$inline);
            delete w.br;
            return function (p, v, I, J) {
                ...
                if (!J.checkReadOnly()) {
                    ...
                    p = {
                        type: v, dontFilter: L, editable: p,
                        editor: F, range: J, blockLimit: K, mergeCandidates: [], zombies: []
                    };
                    v = p.range;
                    J = p.mergeCandidates;
                    var H, t;
                    ...
                    if (!v.collapsed) {
                        var F = K.block || K.blockLimit, x = v.getCommonAncestor();
                        F && !F.equals(x) && !F.contains(x) && v.checkEndOfBlock() &&
                        p.zombies.push(F);
                        v.deleteContents()
                    }
                    for (; (t = e(v)) && a(t) && t.isBlockBoundary() && L.contains(t);) v.moveToPosition(t, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    for (F = H.startNode; (F = F.getParent()) && f(F);) J.push(F);
                    v.moveToBookmark(H);
                    if (H = I) {
                        H = p.range;
                        ...
                        I = p.editor.dataProcessor.toHtml(I, {
                            ...
                            dontFilter: p.dontFilter, filter: p.editor.activeFilter, enterMode: p.editor.activeEnterMode
                        });
                    ...
                    if (H) {
                        ...
                        var P, W;
                        v = y.startContainer;
                        var L = p.endPath.elements[0], X, K = L.getPosition(v),
                        ...
                        for (E(v, y); J < v.length; J++) {
                            ...
                            if (u) I = 0 < J; else {
                                ...
                                if (F && K.isElement) {
                                    ...
                                    if (u) P && (W = y.splitElement(P), p.zombies.push(W), p.zombies.push(P)); else {
                                        P = t.getName();
                                        X = !J;
                                        u = J == v.length - 1;
                                        P = d(K.node, P);
                ...
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(),
                            h = e.contains(CKEDITOR.dtd.$list), g = f.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            ...
                            if (a.mergeList) {
                                var n = f.contains(CKEDITOR.dtd.$list), l = g.contains(CKEDITOR.dtd.$list);
                    ...
                    function a(c) {
                        var e = [], f, h = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d),
                            m = c.endPath().contains(d), n = {};
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var h = c(f, e.bookmark), g = h.clone(), l, k, v = h.getCommonAncestor();
                            v.is(CKEDITOR.dtd.$tableContent) && !v.is(d) && (v = v.getAscendant("table",
                                !0));
                            k = v;
    ...
    (function () {
        ...
        var y, A, t = CKEDITOR.dom.walker.invisible(1), D = function () {
            function a(b) {
                return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, h = CKEDITOR.document, g = e.editable(), n = f.getBody(),
                    k = f.getDocumentElement(), q = g.isInline(), v, I;
        ...
        var p = "function" != typeof window.getSelection, x = 1;
        ...
        var G = {
            ...
            thead: 1,
            tfoot: 1
        }, u = CKEDITOR.tools.repeat("​", 7), r = new RegExp(u + "( )?", "g");
            ...
            getNative: function () {
                ...
                var a = p ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, h, g = b.duplicate(), l = 0, v = e.length - 1, k = -1, m, p; l <= v;) if (k = Math.floor((l + v) / 2), f = e[k], g.moveToElementText(f), m = g.compareEndPoints("StartToStart", b), 0 < m) v = k - 1; else if (0 > m) l = k + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        ...
                        return {container: p, offset: 0 < m ? -g : p.nodeValue.length + g}
                    };
                    return function () {
                ...
                var b = this.getNative(), b = p ? "Control" == b.type ? "" : b.createRange().text :
                    b.toString();
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    a:{
                        ...
                        if (1 == a.length && !(w = a[0]).collapsed && (k = w.getEnclosedNode()) && k.type == CKEDITOR.NODE_ELEMENT && (w = w.clone(), w.shrink(CKEDITOR.SHRINK_ELEMENT,
                                !0), (q = w.getEnclosedNode()) && q.type == CKEDITOR.NODE_ELEMENT && (k = q), "false" == k.getAttribute("contenteditable"))) break a;
                        k = void 0
                    }
                        ...
                        if (p) {
                            ...
                            for (r = 0; r < a.length; r++) {
                                ...
                                try {
                                    ...
                                    if (0 <= I.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) k.collapse(1), u.setEnd(k.endContainer.$, k.endOffset); else throw I;
                                }
                                f.addRange(u)
                            }
                        }
    ...
    (function () {
        ...
        function b(c) {
            var f = c.document;
            if (c.collapsed) f = G(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var p = c.createBookmark(), q = p.startNode, w = p.endNode, t = q, r;
                if (!k) {
                    var u = c.getCommonAncestor(), k = a(q, u), u = a(w, u);
                    k && (t = k.getNextSourceNode(!0));
                    u && (w = u)
                }
                for (t.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                    k = !1;
                    if (t.equals(w)) t = null, k = !0; else {
                        ...
                        if (u && m && CKEDITOR.dtd.$block[y]) for (var A = t, z = e(A), B = void 0, C = z.length, E = 0, A = C && new CKEDITOR.dom.range(A.getDocument()); E < C; ++E) {
                            var B = z[E], R = CKEDITOR.filter.instances[B.data("cke-filter")];
                            if (R ? R.check(this) : 1) A.selectNodeContents(B), b.call(this, A)
                        }
                        z = y ? !n[y] || x ? 0 : u && !m ? 0 : d(t, w, h, T) : 1;
                        if (z) if (B = t.getParent(), z = h, C = g, E = l, !B || !(B.getDtd() || CKEDITOR.dtd.span)[C] && !E || z.parentRule && !z.parentRule(B)) k = !0; else {
                            if (r ||
                                ...
                                for (var y = t, Y; (k = !y.getNext(H)) && (Y = y.getParent(), n[Y.getName()]) && d(Y, q, h, Q);) y = Y;
                                r.setEndAfter(y)
                            }
                        } else k = !0;
        ...
        function t(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = h(this)[a.getName()],
        ...
        var z = {
                ...
                audio: 1,
                video: 1
            }, E = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, H = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, l = c[d ? "endContainer" : "startContainer"], k = d ? "endOffset" : "startOffset",
                        ...
                        if (k && 1 < a.length) {
                            ...
                            if (l) for (var w = 0; a[g + w + 1];) {
                                ...
                                for (f = f.getById(d[w + 1].startNode); ;) {
                                    ...
                                    if (f.equals(q)) l = 1; else if (c(q) || q.type == CKEDITOR.NODE_ELEMENT && q.isBlockBoundary()) continue;
                                    break
                                }
                                if (!l) break;
                                w++
    ...
    (function () {
        ...
        var l = "cke_ui_color", k = [], q = /\$color/g;
...
*/
    ...
    (function () {
        ...
        function Y(a) {
            function b(b) {
                var c = a.getSize(), k = CKEDITOR.document.getWindow().getViewPaneSize(), q = b.data.$.screenX,
                    n = b.data.$.screenY, r = q - d.x, l = n - d.y;
                d = {x: q, y: n};
                e.x += r;
                e.y += l;
            ...
            var d = null, e = null, f = a.getParentEditor(), g = f.config.dialog_magnetDistance,
        ...
        function N(a) {
            var b = CKEDITOR.document.getWindow(), c = a.config, d = c.dialog_backgroundCoverColor || "white",
                e = c.dialog_backgroundCoverOpacity, f = c.baseFloatZIndex, c = CKEDITOR.tools.genKey(d,
                e, f), g = z[c];
        ...
        (function () {
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, d, e, f, g) {
                    ...
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var f = this._.children = b, g = e && e.widths || null, h = e && e.height || null, p,
                            m = {role: "presentation"};
    ...
    (function () {
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            getRangeAtDropPosition: function (b, a) {
                var c = b.data.$, d = c.clientX, e = c.clientY, g = a.getSelection(!0).getRanges()[0],
                    f = a.createRange();
    ...
    CKEDITOR.plugins.add("colorbutton", {
        requires: "panelbutton,floatpanel", init: function (c) {
            ...
            function u(p, h, e) {
                var f = [], l = k.colorButton_colors.split(","),
                    m = c.plugins.colordialog && !1 !== k.colorButton_enableMore, a = l.length + (m ? 2 : 1),
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, b, c) {
                ...
                render: function (a, b, c) {
                    var h = a.id + String(b), e = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state,
                        l = "",
                    ...
                    var f = this.getItems, d = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";",
                        g = this.name;
        ...
        CKEDITOR.plugins.add("toolbar", {
            requires: "button", init: function (a) {
                var d, g = function (c, h) {
                    var b, e = "rtl" == a.lang.dir, k = a.config.toolbarGroupCycling, r = e ? 37 : 39, e = e ? 39 : 37,
                        k = void 0 === k || k;
                    switch (h) {
                        case 9:
    ...
    CKEDITOR.plugins.add("scayt", {
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
            ...
            "boolean" !== typeof a.config.scayt_autoStartup && (a.config.scayt_autoStartup =
                !1);
            ...
            var c = CKEDITOR.plugins.scayt,
                d = a.dataProcessor, b = d && d.htmlFilter, e = a._.elementsPath && a._.elementsPath.filters,
