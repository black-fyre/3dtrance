...
<head>
    ...
    <link rel="stylesheet"
          href="<?php echo K_ADMIN_URL . 'includes/plupload/jquery.plupload.queue/css/'; ?>jquery.plupload.queue.css"
          type="text/css"/>
    ...
    <?php if ($lang != 'en') {
        echo '<script src="' . K_ADMIN_URL . 'includes/plupload/i18n/' . $lang . '.js"></script>';
    } ?>
</head>
<body>
<div id="uploader">
