...
plupload.addI18n({
    ...
    "Add files to the upload queue and click the start button.": "Lisää tiedostoja lähetysjonoon ja klikkaa aloita-nappia.",
    "List": "",
    ...
    "File: %s": "Tiedosto: %s",
    "b": "B",
    "Uploaded %d/%d files": "Lähetetty %d/%d tiedostoa",
    ...
    "File: %s, size: %d, max file size: %d": "Tiedosto: %s, koko: %d, suurin sallittu tiedostokoko: %d",
    "Thumbnails": "",
    "Drag files here.": "Raahaa tiedostot tähän.",
