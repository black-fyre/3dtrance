...
plupload.addI18n({
    ...
    "Add files to the upload queue and click the start button.": "Добавете файлове в опашката за качване, и щракнете бутона старт.",
    "List": "",
    ...
    "File: %s": "Файл: %s",
    "b": "b",
    "Uploaded %d/%d files": "Качени %d/%d файла",
    ...
    "%d files queued": "%d файла в опашката",
    "File: %s, size: %d, max file size: %d": "Файл: %s, размер: %d, максимален размер: %d",
    "Thumbnails": "",
    "Drag files here.": "Довлечете файловете тук.",
