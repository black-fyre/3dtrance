...
class KPagesAdmin extends KBaseAdmin
{
    ...
    function define_list_fields()
    {
        ...
        if (is_array($arr_config)) {
            ...
            if (isset($arr_config['js'])) {
                $arr_js = $arr_config['js'];
            }
            if (isset($arr_config['css'])) {
                $arr_css = $arr_config['css'];
            }
            if (isset($arr_config['html'])) {
                $arr_html = $arr_config['html'];
            }

            if (isset($arr_config['orderby'])) {
                $orderby = $arr_config['orderby'];
            }
            if (isset($arr_config['order'])) {
                $order = $arr_config['order'];
            }
            if (isset($arr_config['limit'])) {
                $limit = $arr_config['limit'];
            }
            if (isset($arr_config['exclude'])) {
                $exclude = $arr_config['exclude'];
            }
            if (isset($arr_config['searchable'])) {
                $searchable = $arr_config['searchable'];
            }
        }
        ...
        if (strlen($exclude)) {
            $CTX->set('k_selected_exclude', $exclude, 'global');
        }
    ...
    {
        global $FUNCS, $CTX, $DB;
        if ($node->name !== 'pages' || $token !== $CTX->get('k_cur_token')) {
            return;
        }
        ...
        if ($orderby !== 'weight' || ($order != 'desc' && $order != 'asc')) {
            return;
        }
    ...
    function define_form_fields()
    {
        ...
        if (is_array($arr_config)) {
            ...
            if (isset($arr_config['params'])) {
                $arr_params = $arr_config['params'];
            }
        }
    ...
    function _custom_admin_screen()
    { // Deprecated now .. included only for legacy support
        global $FUNCS, $CTX;
