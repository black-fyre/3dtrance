...
class KNestable
{
    ...
    function set_children_count($total_siblings = 0, $pos = 0)
    { // prev. named 'set_folders_count'
    ...
    function set_dynamic_count($depth, $exclude, $total_siblings = 0, $pos = 0, $level = 0)
    { //prev. named 'get_folders_count'
