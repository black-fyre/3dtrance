...
<?php echo $FUNCS->login_header(); ?>
    ...
    <cms:form name="frm_login" class="simple-form" action="" method="post" anchor="0"
              onSubmit="this.k_install.disabled=true; return true;">
        <cms:if k_success>
            <cms:php> global $CTX; k_install( $CTX->get('frm_name'), $CTX->get('frm_password'), $CTX->get('frm_email')
                );
            </cms:php>
            ...
            <cms:if k_install_error>
                <div class="alert alert-error alert-icon">
                    <svg class="i">
                        <use xlink:href="<cms:php>echo K_SYSTEM_THEME_URL;</cms:php>assets/open-iconic.svg#circle-x"></use>
                    </svg>
                ...
                <div class="alert alert-success alert-icon">
                    <svg class="i">
                        <use xlink:href="<cms:php>echo K_SYSTEM_THEME_URL;</cms:php>assets/open-iconic.svg#check"></use>
                    </svg>
                    <h2>Installation successful!</h2>
                    Please <a href="<cms:php> echo K_ADMIN_URL . K_ADMIN_PAGE; </cms:php>">log in</a> using the
            ...
            <cms:if k_error>
                ...
                <div class="alert alert-notice alert-icon">
                    <svg class="i">
                        <use xlink:href="<cms:php>echo K_SYSTEM_THEME_URL;</cms:php>assets/open-iconic.svg#warning"></use>
                    </svg>
            ...
            <div class="field prepend">
                <cms:input type="text" id="k_user_name" name="name" maxlength="40"
                           ...
                           autofocus="autofocus" class="text" placeholder="Super-Admin Username"
                'required="required"' value=""/>
                <svg class="i">
                    <use xlink:href="<cms:php>echo K_SYSTEM_THEME_URL;</cms:php>assets/open-iconic.svg#person"></use>
                </svg>
            </div>

            <div class="field prepend">
                <cms:input type="text" id="k_user_email" name="email" required='1' validator='email'
                           class="text" placeholder="Email Address"
                'required="required"' value=""/>
                <svg class="i">
                    <use xlink:href="<cms:php>echo K_SYSTEM_THEME_URL;</cms:php>assets/open-iconic.svg#envelope-closed"></use>
                </svg>
            </div>

            <div class="field prepend">
                <cms:input type="password" id="k_user_pwd" name="password" required="1" validator='min_len=5'
                           autocorrect="off" autocapitalize="off" spellcheck="false" class="password"
                           placeholder="Password"
                'required="required"' value="" />
                <svg class="i">
                    <use xlink:href="<cms:php>echo K_SYSTEM_THEME_URL;</cms:php>assets/open-iconic.svg#lock-locked"></use>
                </svg>
            </div>

            <div class="field prepend">
                <cms:input type="password" id="k_user_pwd_repeat" name="repeat_password" required="1"
                           validator='matches_field=password'
                           autocorrect="off" autocapitalize="off" spellcheck="false" class="password"
            ...
            <div class="simple-btns">
                <button class="btn btn-primary" name="k_install" type="submit">
                    <svg class="i">
                        <use xlink:href="<cms:php>echo K_SYSTEM_THEME_URL;</cms:php>assets/open-iconic.svg#check"></use>
                    </svg>
                    Install
