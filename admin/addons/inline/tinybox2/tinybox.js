...
TINY.box = function () {
    var j, m, b, g, v, orig_scroll = 'xxx', p = 0;
    return {
        show: function (o) {
            v = {
                opacity: 70,
                ...
                if (v.image) {
                    ...
                    x.onreadystatechange = function () {
                        if (x.readyState == 4 && x.status == 200) {
                            ...
                            if (v.returnjs) {
                                var response;
                                response = v.returnjs(x.responseText);
                                if (response && response != '') TINY.box.psh(response, a, w, h);
                            }
                            else {
        ...
        psh: function (c, a, w, h) {
            if (v.modal) {
                orig_scroll = document.body.style.overflow;
        ...
        hide: function () {
            if (v.modal) {
                try {
                    document.body.style.overflow = orig_scroll;
                } catch (e) {
                }
            }
