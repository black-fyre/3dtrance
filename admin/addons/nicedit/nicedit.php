    ...
    function _render($input_name, $input_id, $extra1 = '', $dynamic_insertion = 0)
    {
        ...
        */
        ...
        if (!$dynamic_insertion) {
            ...
            ?>
            $(function(){
            var ed = new nicEditor({iconsPath : '<?php echo K_SYSTEM_THEME_URL; ?>assets/', buttonList : <?php echo $this->buttons; ?><?php if ($this->maxheight) {
                echo ', maxHeight : ' . $this->maxheight;
            } ?>}).panelInstance('<?php echo $input_id; ?>');
            ...
            ob_start();
            ?>
            <img src="<?php echo K_SYSTEM_THEME_URL; ?>assets/blank.gif" alt="" id="<?php echo $input_id ?>_dummyimg"
                 onload="
