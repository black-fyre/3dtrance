    ...
    static function tag_handler($params, $node)
    {
        ...
        foreach ($children as $child) {
            if ($child->type == K_NODE_TYPE_CODE && strtolower($child->name) == 'editable') {
                ...
                if (!$child_name) {
                    die("ERROR: Tag \"" . $node->name . "\" a child region's 'name' attribute is missing");
                }
            ...
            <table class="rr" id="<?php echo $input_id; ?>">
                ...
                <tr>
                    ...
                    <?php foreach ($this->cells as $c) : ?>
                        <th <?php if ($c->col_width) {
                            echo 'style="width:' . $c->col_width . 'px;"';
                        } ?>>
                ...
                for ($x = 0; $x < count($data); $x++) {
                    ...
                    <tr id="<?php echo $input_id; ?>-<?php echo $row_id; ?>">
                        ...
                        <td class="delete">
                            <input type="checkbox" name="delete[]" value="<?php echo $row_id; ?>"
                                   id="delete<?php echo $row_id; ?>"/>
